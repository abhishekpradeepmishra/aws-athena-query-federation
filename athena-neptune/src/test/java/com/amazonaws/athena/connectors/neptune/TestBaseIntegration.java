...
public class TestBaseIntegration {
    ...
    protected static final String DEFAULT_CATALOG = "graph-database-1";
    protected static final String TEST_TABLE = "route";
    protected static final String DEFAULT_SCHEMA = "graph-database-1";
